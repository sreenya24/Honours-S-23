...
def extract_multiple_lines_and_save(result, inputfilename:str,iterations:int, max_distance:int,min_inliers_allowed:int):
    """
    ...
    for index in range(0,iterations):
        ...
        # temp = superimpose_all_inliers(results,width,height, result)
        # plt.figure()
        # plt.axis('off')
        # plt.imshow(temp)
        # plt.show()
...
extract_multiple_lines_and_save(result, "./dilated.png",iterations= 30,max_distance=1, min_inliers_allowed=45)
